...
vector<double> Particle::getPerturbation()
{
  ...
  for (int i = 0; i < 3; i++)
  {
    ...
    {  
      normal_distribution<double> distribution(position[positionParameters[i]], 10);
  ...
  for (int i = 0; i < 4; i++)
  {
    ...
    {  
      normal_distribution<double> distribution(position[orientationParameters[i]], 0.2);
  ...
  for (int i = 0; i < numParameters - 7; i++)
  {
    ...
    {  
      normal_distribution<double> distribution(position[jointParameters[i]], M_PI/6);
